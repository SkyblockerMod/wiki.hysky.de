...
tags:
  - Skyblocker
  - New feature
excerpt: "We're transitioning to a Unity-style versioning scheme to avoid confusion with Minecraft’s numbering system. This update brings exciting new features like Fancy Tab Hud 2.0, Teleport Maze Solver, Dungeon Waypoints, Garden Enhancements, Slayer HUD Improvements, and more. Plus, we've added quality-of-life improvements, event helpers, and crucial bug fixes!"
---
:::caution
Work in progress
